...
$user=$_SESSION['user'];
$year=date('Y');
  $query=mysql_query("SELECT  p.roleid  as usr from personroles p inner join users u on u.personid=p.personid where  u.username='$user'");
...
<html lang="en">
<head>
<title>Advert Freelance Solution</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Freelance Plus</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
   ...
   <li class="submenu"> <a href="#"><i class="icon icon-facetime-video"></i> <span>Platforms</span> <span class="label label-important"></span></a>
      <ul>
        <li><a href="winners.php">My Platforms List</a></li>
      </ul>
    </li>
