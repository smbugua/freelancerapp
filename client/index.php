...
?>
  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_ly"> <a href="myjobs.php"> <i class=" icon-globe"></i>Jobs Completed</a> </li>
      <li class="bg_ls"> <a href="entries.php"> <i class="icon-user"></i>Proposals Received</a> </li> 
      <li class="bg_lo"> <a href="smsnotify.php"> <i class="icon-money"></i>Payments Done</a> </li>
      ...
      <div class="span6">
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-ok"></i></span>
            <h5>Latest Proposals received</h5>
          </div>
