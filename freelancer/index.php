...
$recipts=mysql_query("SELECT * from jobproposal jp inner join jobs j on j.id=jp.jobid where j.assignee_id='$personid' order by jp.id ASC LIMIT 5");
?>
  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      <li class="bg_lb"> <a href="index.php"> <i class="icon-dashboard"></i>My Dasboard </a> </li>
      <li class="bg_lg"> <a href="jobs.php"> <i class="icon-shopping-cart"></i>Jobs</a> </li>
      <li class="bg_ly"> <a href="myjobs.php"> <i class=" icon-globe"></i>My Jobs </a> </li>
      <li class="bg_ls"> <a href="entries.php"> <i class="icon-user"></i>Proposals Made</a> </li> 
      <li class="bg_lo"> <a href="smsnotify.php"> <i class="icon-money"></i>Payments Received</a> </li>
