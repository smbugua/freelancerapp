    ...
    <body>
        <div class="container">
			...
			<header>
				...
				<h1>Freelance Plus <strong>Login </strong> Module</h1>
			...
			<section class="main">
				<form class="form-2" action="signin.php" method="post">
					<h1><span class="log-in">Log in</span> Form <span class="sign-up"></span></h1>
					<p class="float">
					...
					<p class="clearfix">  
						...
						<a href="signup.php" class="log-twitter">Sign Up</a> 
